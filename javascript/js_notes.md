...
Entries are added chronologically (oldest first). These notes will be reorganized into logical chapters once they grow large enough to need them — see the `add-note` skill for how new entries are added.
